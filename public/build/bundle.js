...
var app = (function () {
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$5, 10, 2, 146);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 13, 4, 224);
    			attr_dev(h2, "class", "svelte-lym3nh");
    			add_location(h2, file$4, 14, 4, 245);
    			attr_dev(p0, "class", "svelte-lym3nh");
    			add_location(p0, file$4, 15, 4, 269);
    			attr_dev(header, "class", "svelte-lym3nh");
    			add_location(header, file$4, 12, 2, 211);
    			...
    			add_location(img, file$4, 19, 4, 325);
    			attr_dev(div0, "class", "image svelte-lym3nh");
    			add_location(div0, file$4, 18, 2, 301);
    			attr_dev(p1, "class", "svelte-lym3nh");
    			add_location(p1, file$4, 23, 4, 398);
    			attr_dev(div1, "class", "content svelte-lym3nh");
    			add_location(div1, file$4, 22, 2, 372);
    			attr_dev(footer, "class", "svelte-lym3nh");
    			add_location(footer, file$4, 26, 2, 431);
    			attr_dev(article, "class", "svelte-lym3nh");
    			add_location(article, file$4, 11, 0, 199);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 10, 4, 206);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 16, 4, 371);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-xzzzlr");
    			add_location(input, file$1, 14, 4, 318);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    ...
    class TextInput extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*controlType*/ ctx[1] === undefined && !('controlType' in props)) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file, 55, 2, 1575);
    			attr_dev(main, "class", "svelte-14fgpj0");
    			add_location(main, file, 54, 0, 1566);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
